      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12">
          ...
          <p className="text-[11px] text-slate-400 max-w-4xl leading-relaxed text-center lg:text-left font-medium uppercase tracking-wider">
            ...
            Visite <Link href="https://www.srij.turismodeportugal.pt/pt/jogo-responsavel/o-que-e-o-jogo-responsavel" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors underline decoration-1 underline-offset-4">SRIJ</Link>, <Link href="https://jogoresponsavel.pt/" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors underline decoration-1 underline-offset-4">Jogo Responsável</Link> ou <Link href="https://www.icad.pt/" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors underline decoration-1 underline-offset-4">ICAD</Link> para mais informações. 
